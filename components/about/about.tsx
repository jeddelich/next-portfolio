        ...
        <div className="row">
          ...
          <div className={styles.aboutGrid}>
            <div className={styles.aboutProse}>
              ...
              <p>
                <strong>Having traveled to 35+ countries, to me learning is not just a thing you do; it's a lifestyle</strong>. I am not afraid to ask questions, or to approach things from a different point of view. Understanding people and their problems is the only way for us to write good code.
              </p>
              <p>
